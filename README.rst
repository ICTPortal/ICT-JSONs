...
It’s essentially the **textbook content converted into structured JSON**, ready to use in applications, websites, or AI models.
...
- `e-Thaksalawa ICT Textbooks <https://e-thaksalawa.moe.gov.lk>`_
...
- Websites or apps displaying lessons
- AI training or chatbots
- Quizzes, educational tools, or learning management systems
...
- PDFs from e-Thaksalawa are included in the `resources/` folder for reference.
